...
_react2["default"].createElement('a',{className:prefixCls+'-button',role:'button',style:buttonStyle,href:'#',onClick:onClickFn},
button.text||'Button'));
...
var footerDom=footer.length?_react2["default"].createElement('div',{className:btnGroupClass,role:'group'},
