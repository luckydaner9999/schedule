...
if(mode==='closable'){
operationDom=_react2["default"].createElement('div',{className:prefixCls+'-operation',onClick:this.onClick,role:'button','aria-label':'close'},
_react2["default"].createElement(_icon2["default"],{type:'cross',size:'md'}));

}else
{
if(mode==='link'){
operationDom=_react2["default"].createElement('div',{className:prefixCls+'-operation',role:'button','aria-label':'go to detail'},
...
style:{}},
marqueeProps);
return this.state.show?_react2["default"].createElement('div',(0,_extends3["default"])({className:wrapCls},restProps,extraProps,{role:'alert'}),
icon?_react2["default"].createElement('div',{className:prefixCls+'-icon','aria-hidden':'true'},' ',icon,' '):null,
