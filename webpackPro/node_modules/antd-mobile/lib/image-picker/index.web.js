...
_react2["default"].createElement('div',{className:prefixCls+'-item-remove',role:'button','aria-label':'Click and Remove this image',onClick:function onClick(){_this2.removeImage(index);}}),
_react2["default"].createElement('div',{className:prefixCls+'-item-content',role:'button','aria-label':'Image can be clicked',onClick:function onClick(){_this2.onImageClick(index);},style:imgStyle}))));
...
_react2["default"].createElement('div',{className:prefixCls+'-item '+prefixCls+'-upload-btn',onClick:onAddImageClick,role:'button','aria-label':'Choose and add image'},
...
_react2["default"].createElement('div',{className:prefixCls+'-list',role:'group'},
