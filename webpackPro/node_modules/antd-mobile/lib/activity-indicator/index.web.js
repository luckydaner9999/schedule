...
text?_react2["default"].createElement('div',{className:prefixCls+'-content'},
_react2["default"].createElement('span',{className:spinnerClass,'aria-hidden':'true'}),
_react2["default"].createElement('span',{className:prefixCls+'-toast'},text)):
...
{
return text?_react2["default"].createElement('div',{className:wrapClass},
_react2["default"].createElement('span',{className:spinnerClass,'aria-hidden':'true'}),
_react2["default"].createElement('span',{className:prefixCls+'-tip'},text)):
_react2["default"].createElement('div',{className:wrapClass},
_react2["default"].createElement('span',{className:spinnerClass,'aria-label':'loading'}));
