...
module.exports = {
    entry: {
       ...
       /* vendor: ['react','react-dom','react-tappable','underscore','react-routers'],*/
        app: [ './render/app.js']
        // app: [ './app.js'],
    },

    output: {
        path: path.join(__dirname, 'build'), //出口文件，生成一个dist文件，打包后的文件都在这里里面
        publicPath: '/build/',
    ...
    plugins: [
        ...
        new webpack.optimize.CommonsChunkPlugin({
            ...
            // chunks: ['react','react-dom','jquery','react-tappable','underscore','react-routers'],
