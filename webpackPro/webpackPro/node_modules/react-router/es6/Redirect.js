...
var Redirect = (function (_Component) {
  ...
  Redirect.prototype.render = function render() {
    !false ? process.env.NODE_ENV !== 'production' ? invariant(false, '<Redirect> elements are for routers configuration only and should not be rendered') : invariant(false) : undefined;
  };
