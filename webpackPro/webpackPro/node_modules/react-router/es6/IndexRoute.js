...
var IndexRoute = (function (_Component) {
  ...
  IndexRoute.prototype.render = function render() {
    !false ? process.env.NODE_ENV !== 'production' ? invariant(false, '<IndexRoute> elements are for routers configuration only and should not be rendered') : invariant(false) : undefined;
  };
