...
var IndexRedirect = (function (_Component) {
  ...
  IndexRedirect.prototype.render = function render() {
    !false ? process.env.NODE_ENV !== 'production' ? invariant(false, '<IndexRedirect> elements are for routers configuration only and should not be rendered') : invariant(false) : undefined;
  };
