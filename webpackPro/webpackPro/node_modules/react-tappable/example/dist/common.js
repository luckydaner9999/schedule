...
var ReactCompositeComponentMixin = {
  ...
  attachRef: function (ref, component) {
    ...
    !(inst != null) ? "production" !== 'production' ? invariant(false, 'Stateless function component cannot have refs.') : invariant(false) : undefined;
    var publicComponentInstance = component.getPublicInstance();
    if ("production" !== 'production') {
      var componentName = component && component.getName ? component.getName() : 'a component';
      "production" !== 'production' ? warning(publicComponentInstance != null, 'Stateless function component cannot be given refs ' + '(See ref "%s" in %s created by %s). ' + 'Attempts to access this ref will fail.', ref, componentName, this.getName()) : undefined;
    }
  ...
  unmountComponent: function () {
    switch (this._tag) {
      ...
      case 'body':
         ...
         */
        !false ? "production" !== 'production' ? invariant(false, '<%s> tried to unmount. Because of cross-browser quirks it is ' + 'impossible to unmount some top-level component (eg <html>, ' + '<head>, and <body>) reliably and efficiently. To fix this, have a ' + 'single top-level component that never unmounts render these ' + 'elements.', this._tag) : invariant(false) : undefined;
        break;
    }
...
var ReactElementValidator = {
  ...
  createElement: function (type, props, children) {
    ...
    "production" !== 'production' ? warning(validType, 'React.createElement: type should not be null, undefined, boolean, or ' + 'number. It should be a string (for DOM elements) or a ReactClass ' + '(for composite component).%s', getDeclarationErrorAddendum()) : undefined;
...
function runBatchedUpdates(transaction) {
  ...
  !(len === dirtyComponents.length) ? "production" !== 'production' ? invariant(false, 'Expected flush transaction\'s stored dirty-component length (%s) to ' + 'match dirty-component array length (%s).', len, dirtyComponents.length) : invariant(false) : undefined;
...
function instantiateReactComponent(node) {
  ...
  if (node === null || node === false) {
    ...
    var element = node;
    !(element && (typeof element.type === 'function' || typeof element.type === 'string')) ? "production" !== 'production' ? invariant(false, 'Element type is invalid: expected a string (for built-in component) ' + 'or a class/function (for composite component) but got: %s.%s', element.type == null ? element.type : typeof element.type, getDeclarationErrorAddendum(element._owner)) : invariant(false) : undefined;
