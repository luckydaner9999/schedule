...
_react2["default"].createElement(_list2["default"],{role:'tablist'},
data.map(function(dataItem,index){return _react2["default"].createElement(_list2["default"].Item,{className:dataItem.value===firstLevelSelectValue?prefixCls+'-selected':'',onClick:function onClick(){return _this2.onClickFirstLevelItem(dataItem);},key:'listitem-1-'+index,role:'tab','aria-selected':dataItem.value===firstLevelSelectValue},
dataItem.label);}))):


null,
_react2["default"].createElement(_flex2["default"].Item,{style:heightStyle,role:'tabpanel','aria-hidden':'false'},
